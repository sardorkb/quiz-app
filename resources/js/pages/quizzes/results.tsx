                        ...
                        <Table>
                            <TableHeader>
                                <TableRow>
                                    ...
                                    <TableHead>Yutuq (so'm)</TableHead>
                                    <TableHead>Yakunlangan Vaqt</TableHead>
                                </TableRow>
                            </TableHeader>
                            <TableBody>
                                {attempts.length ? (
                                    attempts.map((attempt) => (
                                        <TableRow key={attempt.id}>
                                            ...
                                            <TableCell>{(attempt.score * 10000).toLocaleString('uz-UZ')}</TableCell>
                                            <TableCell>{formatTimeTaken(attempt.time_taken)}</TableCell>
                                        </TableRow>
                                    ))
                                ) : (
                                    <TableRow>
